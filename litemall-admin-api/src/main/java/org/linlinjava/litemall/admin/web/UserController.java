...
public class UserController {
    ...
    @GetMapping("/list")
    public Object list(
                       String username, String mobile,Integer type,String nickname,
                       @RequestParam(value = "page", defaultValue = "1") Integer page,
                       @RequestParam(value = "limit", defaultValue = "10") Integer limit,
                       String sort, String order){
        order = "add_time desc";
        List<LitemallUser> userList = userService.querySelective(username, mobile, "","",type,nickname,page, limit, sort, order);
        int total = userService.countSeletive(username, mobile,"", "",type,nickname,page, limit, sort, order);
