...
public class IntegretionDetailsController {
    ...
    public Object create(@RequestBody IntegretionDetail integretionDetail) {
        Map<String, Object> data = new HashMap<>();
        IntegretionDetail detail = integretionDetailService.querySelective2(integretionDetail.getUserId(), DateUtils.getDayStartString(), DateUtils.getDayEndString(), Integer.valueOf(integretionDetail.getType()));
        if (detail == null) {
