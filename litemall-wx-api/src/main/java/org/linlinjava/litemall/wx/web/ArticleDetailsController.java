...
public class ArticleDetailsController {
     ...
     */
    @PostMapping("add")
    public Object list(Integer userId,@RequestBody ArticleDetails articleDetails){
        if(userId == null){
     ...
     */
    @PostMapping("update")
    public Object save(Integer userId, @RequestBody ArticleDetails articleDetails) {
        if(userId == null){
            return ResponseUtil.unlogin();
        }
        if(articleDetails == null){
